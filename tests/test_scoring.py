...
from ats_resume_scorer.main import (
    ATSScoringEngine, ScoringWeights, ResumeData, 
    JobDescription, ContactInfo, Experience, Education
)
...
class TestATSScoringEngine:
    ...
    def setup_method(self):
        ...
        self.sample_resume = ResumeData(
            ...
            education=[
                Education(degree="Bachelor of Science in Computer Science", institution="Test University")
            ],
            experience=[
                Experience(
    ...
    def test_keyword_match_scoring(self):
        ...
        score = self.scorer.calculate_keyword_match_score(self.sample_resume, self.sample_jd)
    ...
    def test_title_match_scoring(self):
        ...
        score = self.scorer.calculate_title_match_score(self.sample_resume, self.sample_jd)
    ...
    def test_overall_scoring(self):
        ...
        expected_categories = [
            'keyword_match', 'title_match', 'education_match',
            'experience_match', 'format_compliance', 
            'action_verbs_grammar', 'readability'
        ]
    ...
    def test_custom_weights(self):
        ...
        result = custom_scorer.calculate_overall_score(self.sample_resume, self.sample_jd)
